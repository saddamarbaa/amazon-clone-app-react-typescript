...
export const allProductMockData: ProductType[] = [
	{
		id: 56,
...
export const allProductMockData2: ProductType[] = [
	{
		id: 56,
		title: 'Samsung Galaxy Watch 4',
		stock: 'in stock - order soon.',
...
export const electronicProductMockData = [
	{
		id: 9,
		title: 'WD 2TB Elements Portable External Hard Drive - USB 3.0 ',
		price: 64,
...
export const generalProductMockData = [
	{
		id: 1,
		title: 'Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops',
		price: 109.95,
...
const itemsFixPrice = allProductMockData.map((item) => item.price)
